...
region1 = Box(pitch, "reflective")
fueldens, cooldens = 0.2, 0.7
tpms_clad1, tpms_fuel1, tpms_fuel2, tpms_clad2 = openmc.TPMS.from_relative_densities("Schwarz_P", [cooldens/2,0.5-fueldens/2,0.5+fueldens/2,1-cooldens/2], pitch=pitch)
