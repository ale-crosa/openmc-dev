...
tpms_clad1, tpms_fuel1, tpms_fuel2, tpms_clad2 = openmc.TPMS.from_relative_densities("Gyroid", [cooldens/2,0.5-fueldens/2,0.5+fueldens/2,1-cooldens/2], pitch=1/2)
