...
public:
  ...
  rootFinding root_in_interval_derivatives(double L0, double L1, Position r, Direction u);
  rootFinding root_in_interval_subintervals(double L0, double L1, Position r, Direction u, int n_subintervals);
